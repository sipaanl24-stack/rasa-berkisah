...
<div class="transaction-content">
    <div class="transaction-header">
        <div>
            <h2 class="transaction-title">Transaction Management</h2>
            <p class="transaction-subtitle">On Hold & Transaction History</p>
        </div>
    </div>
    ...
    <div class="transaction-card">
        <ul class="nav nav-tabs transaction-tabs mb-4">
            <li class="nav-item">
                <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#onhold"> On Hold </button>
            </li>
            <li class="nav-item">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active" id="onhold">
